...
public class SubarrayTest {
	...
	public void positiveList() {
		...
		assertArrayEquals(new Integer[] { 9, 6 }, obj.getP2().toArray());
		assertEquals(Integer.valueOf(15), obj.getS2());
		assertArrayEquals(new Integer[] { 5 }, obj.getP3().toArray());
		assertEquals(Integer.valueOf(5), obj.getS3());
	...
	public void negativeList() {
		...
		assertArrayEquals(new Integer[] { -3, -5 }, obj.getP2().toArray());
		assertEquals(Integer.valueOf(-8), obj.getS2());
		assertArrayEquals(new Integer[] { -8 }, obj.getP3().toArray());
		assertEquals(Integer.valueOf(-8), obj.getS3());
	...
	public void mixList() {
		...
		assertTrue(obj.validate());
		obj.compute();
		assertArrayEquals(new Integer[] { 1, -2, 3, -4, 5 }, obj.getP1().toArray());
		assertEquals(Integer.valueOf(3), obj.getS1());
		assertArrayEquals(new Integer[] { -6, 7, -8 }, obj.getP2().toArray());
		assertEquals(Integer.valueOf(-7), obj.getS2());
		assertArrayEquals(new Integer[] { 9 }, obj.getP3().toArray());
		assertEquals(Integer.valueOf(9), obj.getS3());
		assertEquals(Integer.valueOf(1), obj.getMin());
	}
}
